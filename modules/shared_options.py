...
options_templates.update(options_section(('ui', "User interface", "ui"), {
    ...
    "quicksettings_list": OptionInfo(["sd_model_checkpoint", "sd_vae", "CLIP_stop_at_last_layers", "inpainting_mask_weight", "initial_noise_multiplier"], "Quicksettings list", gr.CheckboxGroup, lambda: {"choices": list(options_templates.keys())}),
